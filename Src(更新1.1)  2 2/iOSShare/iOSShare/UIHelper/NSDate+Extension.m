...
{
	return [self stringDateWithFormat:formatString Local:[[NSLocale currentLocale] localeIdentifier]];
}

-(NSString*)stringDateWithFormat:(NSString *)formatString Local:(NSString *)local
{
    NSDateFormatter *format=[[DFDateFormatterFactory sharedFactory] dateFormatterWithFormat:formatString andLocale:[NSLocale localeWithLocaleIdentifier:local]];
    NSString *str=[format stringFromDate:self];
    return str;
}
